                    ...
                    <div class="modal-dialog modal-lg">
                      ...
                      <div class="modal-body">
                        ...
                        <div class="reply">
                          ...
                          <textarea name="repContent" id="repContent" cols="90" rows="6" maxlength="300"></textarea>
                        </div>
                      </div>
            
                      <!-- Modal footer -->
                      <div class="modal-footer">
                        <button type="button" class="btn btn-save" id="reply_btn1" data-dismiss="modal">저장</button>
                        <button type="button" class="btn" id="reply_btn2" data-dismiss="modal">닫기</button>
                      </div>
                      </form>
                      </div>      
                    </div>
